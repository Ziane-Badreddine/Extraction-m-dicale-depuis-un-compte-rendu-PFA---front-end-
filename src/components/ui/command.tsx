...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded backdrop-blur-md",
        className
      )}
      {...props}
    />
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "md:min-h[440px] md:max-h[440px] scroll-py-1 overflow-x-hidden overflow-y-auto",
        className
      )}
      {...props}
    />
